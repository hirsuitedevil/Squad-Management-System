...
<title> View Player Detail</title>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">View Player Details</strong>
						</div>
						<div class="card-body">
						<table class="table">
						<thead>
							...
							<%
									...
									ResultSet resultset = statement.executeQuery("select * from tblplayer where TeamID='" + cid + "'");
